...
user_storage = UserFileStorage(config.FILE_NAMES)
language_storage = LanguageFileStorage(config.FILE_NAMES)
dictionary_storage = DictionaryFileStorage(config.DICTIONARY_DATA)
session_storage = SessionFileStorage(config.SESSIONS_DATA)
stats_storage = StatsFileStorage(config.STATS_DATA)
